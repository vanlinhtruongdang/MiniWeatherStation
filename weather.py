...
Dataset = pd.DataFrame(columns=['datetime', 'temperature', 'wind_speed', 'humidity', 'cloud', 'pressure', 'visibility', 'rain'])
...
if __name__ == '__main__':
    ...
    schedule.every(interval=30).minutes.do(GetWeatherData)
